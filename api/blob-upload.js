...
const ALLOWED_CONTENT_TYPES = [
  ...
  "image/png",
  "image/webp",
  // image/gif: usado pela aba Ortofoto (protótipo) - matrículas nunca enviam gif.
  // TIFF/GeoTIFF e BMP NUNCA chegam aqui crus: o navegador sempre os converte
  // para PNG antes do upload (ver lib/ortofoto.js), porque a Anthropic e o
  // restante do pipeline não leem esses formatos diretamente.
  "image/gif"
];
